...
sealed class NavigationItem(val route: String, val icon: Int, val title: Int) {
    ...
    object Charts: NavigationItem("charts", R.drawable.ic_home, R.string.title_charts)
    object History: NavigationItem("history", R.drawable.ic_home, R.string.title_history)
}